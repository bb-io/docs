...
- **Add provenance** Add translation or review provenance to any file supported by Blackbird Filters and return an XLIFF 2.2 file. Person, organization, tool, and their reference alternatives are optional.
