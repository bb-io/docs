...
Before you can connect you need to make sure that you have a Lark or Feishu account, you are set up as an admin, and the bot is enabled for the necessary groups.

## Creating Lark or Feishu custom application

To create a Lark or Feishu custom application, follow these steps:
1. Open the developer console for your platform:
   - Lark: [Lark Developer Console](https://open.larksuite.com/app?lang=en-US)
...
5. After creating the custom application, you will be redirected to the **Add features** page.
 
   ![example2](https://raw.githubusercontent.com/bb-io/Lark/main/Apps.Lark/image/features-example.png)

6. Select the features you want to add to your application. For the current configuration, you will need **Bot**, **Web app**, **Workplace block**, and **Base record view**.
7. After configuring the features, release the app version.

   ![example3](https://raw.githubusercontent.com/bb-io/Lark/main/Apps.Lark/image/release-version-example.png)

## Adding scopes

To add scopes to your Lark or Feishu application, go to **Permissions & Scopes**.
...
1. Open your Lark or Feishu developer console.
