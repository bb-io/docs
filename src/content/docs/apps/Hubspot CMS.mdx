...
- **Download rows content** Downloads specified columns and rows from a HubDb table into an HTML file
- **Upload rows content** Create or update HubDB rows from an HTML file
