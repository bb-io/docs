---
  ...
  description: The Microsoft Teams Blackbird app
---
import { LinkCard } from "@astrojs/starlight/components";
import { YouTube } from '@astro-community/astro-embed-youtube';

<LinkCard title="View on Github" target="_blank" href="https://github.com/bb-io/MicrosoftTeams" icon="github" />
...
![Searching for Blackbird application](https://raw.githubusercontent.com/bb-io/MicrosoftTeams/main/image/README/searching_for_app.png)
...
![Enable admin consent workflow](https://raw.githubusercontent.com/bb-io/MicrosoftTeams/main/image/README/enable-admin-consent-workflow.png)
...
- Go to _Manage_ > _API permissions_ and select the required scopes:
    ...
    * Alternatively, use the `OAuth2 (Azure app) with custom scopes` connection type to specify your own scopes. 
      ...
      Include the `User.Read` scope in your custom scopes and make sure it is also added 
      under API permissions in your Azure app, as it is used to validate the connection.
...
![Connecting using OAuth2](https://raw.githubusercontent.com/bb-io/MicrosoftTeams/main/image/README/oauth.png)
...
![Connecting using Azure app](https://raw.githubusercontent.com/bb-io/MicrosoftTeams/main/image/README/azure.png)
...
2. Enter your Azure app scopes, space-separated. Example: `User.Read Team.ReadBasic.All Channel.ReadBasic.All Chat.Read`.
3. Follow the instructions that Microsoft gives you, authorizing Blackbird.io to act on your behalf.
4. When you return to Blackbird, confirm that the connection has appeared and the status is _Connected_.
 
![Connecting using Azure app](https://raw.githubusercontent.com/bb-io/MicrosoftTeams/main/image/README/azure_customscopes.png)
