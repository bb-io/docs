...
- **On subitem created**: This event is triggered when a subitem is created.
- **On subitem column changed**: This event is triggered when a column value of a subitem changes.
